...
-- I'm using the Infamy tweak data init as it is the init called directely after the 'dlc' init
Hooks:PostHook(InfamyTweakData, "init", "BeardLibInfamyTweakDataInit", function(self, tweak_data)
    self.mod = {
        free = true,
        content = {
    ...
    --CustomDLCManager:PushTweak(tweak_data)
end)
