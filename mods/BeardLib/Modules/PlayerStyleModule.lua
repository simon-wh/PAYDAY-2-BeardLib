...
PlayerStyleModule = PlayerStyleModule or class(ItemModuleBase)
PlayerStyleModule.type_name = "PlayerStyle"
...
BeardLib:RegisterModule(PlayerStyleModule.type_name, PlayerStyleModule)
